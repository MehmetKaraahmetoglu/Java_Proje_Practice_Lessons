...
public class C01_atm_uygulamasi {
     /*
    ATM
...
Menu_Runner listesinde Bakiye sorgula, para yatirma, para çekme, para gönderme, sifre değiştirme ve cikis islemleri olacaktır.
